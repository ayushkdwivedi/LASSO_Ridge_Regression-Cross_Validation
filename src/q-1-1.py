...
if __name__ == "__main__":
    ...
    plt.ylabel('Error')
    plt.title("Variation of Error with respect to $\lambda$ ($\lambda \in range(0,{},{})$ for 'Lasso' Regulrization".format(lambdaa-1,step))
    plt.legend()
    ...
    plt.title("Variation of Parameters with respect to $\lambda$ ($\lambda \in range(0,{},{})$ for 'Lasso' Regulrization".format(lambdaa-1,step))
    plt.legend()
